...
async function handleStateInput(bot, msg, lang) {
  ...
  if (currentState.type === 'await_bol_trailer_numbers' && telegramId === ADMIN_ID) {
    ...
    try {
      ...
      await bot.sendMessage(chatId, '❌ Failed to generate BOL PDFs. Please check that BOL_template.docx contains {{TRA}} markers and DOCX->PDF conversion is available.');
    }
