...
## Оновлення
- Додано CRUD-операції для водіїв і звітів (create/update/delete) через UI.
- Broadcast тепер дозволяє вибрати водія зі списку (ім'я + telegram_id), а не вводити ID вручну.
- Таблиці адаптовані під телефон: горизонтальний скрол і мобільна сітка форм.
